...
// © 2025 Michael Ostermann - IT Admin Services Template
...
(function() {
    ...
    const COPYRIGHT = {
        ...
        year: '2025',
        template: 'IT Admin Services Template',
    ...
    function showConsoleWarning() {
        ...
        console.clear();
        console.log('%c⚽ 💻 IT ADMIN SERVICES TEMPLATE', style1);
            ...
            mutations.forEach((mutation) => {
                ...
                if (footer) {
                    ...
                    if (!text.includes(COPYRIGHT.owner)) {
                        ...
                        if (p) {
                            p.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • IT Admin Services Template`;
                        }
                    }
                }
            });
    ...
    function startPeriodicCheck() {
        setInterval(() => {
            ...
            if (footer && !footer.textContent.includes(COPYRIGHT.owner)) {
                footer.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • IT Admin Services Template`;
            }
