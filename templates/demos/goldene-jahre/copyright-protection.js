...
// © 2025 Michael Ostermann - Goldene Jahre Template
...
(function() {
    ...
    const COPYRIGHT = {
        ...
        year: '2025',
        template: 'Goldene Jahre Template',
    ...
    function showConsoleWarning() {
        ...
        console.clear();
        console.log('%c⚽ 👴 GOLDENE JAHRE TEMPLATE', style1);
            ...
            mutations.forEach((mutation) => {
                ...
                if (footer) {
                    ...
                    if (!text.includes(COPYRIGHT.owner)) {
                        ...
                        if (p) {
                            p.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Goldene Jahre Template`;
                        }
                    }
                }
            });
    ...
    function startPeriodicCheck() {
        setInterval(() => {
            ...
            if (footer && !footer.textContent.includes(COPYRIGHT.owner)) {
                footer.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Goldene Jahre Template`;
            }
