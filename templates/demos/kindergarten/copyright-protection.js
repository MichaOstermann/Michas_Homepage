...
// © 2025 Michael Ostermann - Werder Fans Community Template
...
(function() {
    ...
    const COPYRIGHT = {
        ...
        year: '2025',
        template: 'Werder Fans Community Template',
    ...
    function showConsoleWarning() {
        const style1 = 'background: #1D9A50; color: white; font-size: 20px; font-weight: bold; padding: 10px 20px;';
        const style2 = 'background: #FF4444; color: white; font-size: 14px; padding: 10px; font-weight: bold;';
        const style3 = 'font-size: 12px; color: #1D9A50;';
        
        console.clear();
        console.log('%c⚽ WERDER FANS COMMUNITY TEMPLATE', style1);
    ...
    function createCopyrightBadge() {
        ...
        badge.style.cssText = `
            ...
            left: 10px !important;
            background: rgba(29, 154, 80, 0.9) !important;
    ...
    function createHiddenMarkers() {
        ...
        const comment1 = document.createComment(`
            ═══════════════════════════════════════════════════════════
            WERDER FANS COMMUNITY TEMPLATE
            ...
            mutations.forEach((mutation) => {
                ...
                if (footer) {
                    ...
                    if (!text.includes(COPYRIGHT.owner)) {
                        ...
                        if (p) {
                            p.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Werder Fans Community Template`;
                        }
                    }
                }
            });
    ...
    document.addEventListener('contextmenu', function(e) {
        if (e.ctrlKey) {
            console.log('%c⚠️ COPYRIGHT HINWEIS', 'background: #1D9A50; color: white; font-size: 14px; padding: 5px 10px;');
    ...
    function startPeriodicCheck() {
        setInterval(() => {
            ...
            if (footer && !footer.textContent.includes(COPYRIGHT.owner)) {
                footer.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Werder Fans Community Template`;
            }
    ...
    function init() {
        ...
        console.log('%c✅ Copyright-Schutz aktiviert', 'color: #1D9A50; font-weight: bold;');
    }
...
console.log('%c© 2025 Michael Ostermann', 'font-size: 14px; color: #1D9A50; font-weight: bold;');
