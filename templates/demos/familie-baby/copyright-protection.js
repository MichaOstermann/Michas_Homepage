...
(function() {
    ...
    const COPYRIGHT = {
        ...
        year: '2025',
        template: 'Familie & Baby Template',
    ...
    function showConsoleWarning() {
        ...
        console.clear();
        console.log('%c👨‍👩‍👧‍👦 FAMILIE & BABY TEMPLATE', style1);
            ...
            mutations.forEach((mutation) => {
                ...
                if (footer) {
                    ...
                    if (!text.includes(COPYRIGHT.owner)) {
                        ...
                        if (p) {
                            p.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Familie & Baby Template`;
                        }
                    }
                }
            });
    ...
    function startPeriodicCheck() {
        setInterval(() => {
            ...
            if (footer && !footer.textContent.includes(COPYRIGHT.owner)) {
                footer.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Familie & Baby Template`;
            }
