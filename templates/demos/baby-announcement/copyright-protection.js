...
(function() {
    ...
    const COPYRIGHT = {
        ...
        year: '2025',
        template: 'Baby Announcement Template',
    ...
    function showConsoleWarning() {
        ...
        console.clear();
        console.log('%c👶 BABY ANNOUNCEMENT TEMPLATE', style1);
            ...
            mutations.forEach((mutation) => {
                ...
                if (footer) {
                    ...
                    if (!text.includes(COPYRIGHT.owner)) {
                        ...
                        if (p) {
                            p.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Baby Announcement Template`;
                        }
                    }
                }
            });
    ...
    function startPeriodicCheck() {
        setInterval(() => {
            ...
            if (footer && !footer.textContent.includes(COPYRIGHT.owner)) {
                footer.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Baby Announcement Template`;
            }
