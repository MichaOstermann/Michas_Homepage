...
(function() {
    ...
    const COPYRIGHT = {
        ...
        year: '2025',
        template: 'Beauty & Kosmetik Template',
    ...
    function showConsoleWarning() {
        ...
        console.clear();
        console.log('%c💄 BEAUTY & KOSMETIK TEMPLATE', style1);
            ...
            mutations.forEach((mutation) => {
                ...
                if (footer) {
                    ...
                    if (!text.includes(COPYRIGHT.owner)) {
                        ...
                        if (p) {
                            p.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Beauty & Kosmetik Template`;
                        }
                    }
                }
            });
    ...
    function startPeriodicCheck() {
        setInterval(() => {
            ...
            if (footer && !footer.textContent.includes(COPYRIGHT.owner)) {
                footer.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Beauty & Kosmetik Template`;
            }
