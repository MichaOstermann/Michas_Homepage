...
// © 2025 Michael Ostermann - Frieden Ukraine Template
...
(function() {
    ...
    const COPYRIGHT = {
        ...
        year: '2025',
        template: 'Frieden Ukraine Template',
    ...
    function showConsoleWarning() {
        ...
        console.clear();
        console.log('%c⚽ 🕊️ FRIEDEN UKRAINE TEMPLATE', style1);
            ...
            mutations.forEach((mutation) => {
                ...
                if (footer) {
                    ...
                    if (!text.includes(COPYRIGHT.owner)) {
                        ...
                        if (p) {
                            p.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Frieden Ukraine Template`;
                        }
                    }
                }
            });
    ...
    function startPeriodicCheck() {
        setInterval(() => {
            ...
            if (footer && !footer.textContent.includes(COPYRIGHT.owner)) {
                footer.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • Frieden Ukraine Template`;
            }
