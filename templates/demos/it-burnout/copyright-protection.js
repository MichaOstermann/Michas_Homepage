...
// © 2025 Michael Ostermann - IT Burnout Template
...
(function() {
    ...
    function showConsoleWarning() {
        ...
        console.clear();
        console.log('%c⚽ 💀 IT BURNOUT TEMPLATE', style1);
            ...
            mutations.forEach((mutation) => {
                ...
                if (footer) {
                    ...
                    if (!text.includes(COPYRIGHT.owner)) {
                        ...
                        if (p) {
                            p.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • IT Burnout Template`;
                        }
                    }
                }
            });
    ...
    function startPeriodicCheck() {
        setInterval(() => {
            ...
            if (footer && !footer.textContent.includes(COPYRIGHT.owner)) {
                footer.innerHTML = `&copy; ${COPYRIGHT.year} ${COPYRIGHT.owner} • IT Burnout Template`;
            }
