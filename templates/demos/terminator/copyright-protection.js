...
// © 2025 Michael Ostermann - Terminator Template
...
(function() {
    ...
    function showConsoleWarning() {
        const style1 = 'background: #00FF41; color: #000; font-size: 20px; font-weight: bold; padding: 10px 20px;';
        const style2 = 'background: #FF4444; color: white; font-size: 14px; padding: 10px; font-weight: bold;';
        const style3 = 'font-size: 12px; color: #00FF41;';
        
        console.clear();
        console.log('%c◢ CYBERDYNE SYSTEMS TEMPLATE', style1);
    ...
    document.addEventListener('contextmenu', function(e) {
        if (e.ctrlKey) {
            console.log('%c⚠️ COPYRIGHT HINWEIS', 'background: #00FF41; color: #000; font-size: 14px; padding: 5px 10px;');
    ...
    function init() {
        ...
        console.log('%c✅ Copyright-Schutz aktiviert', 'color: #00FF41; font-weight: bold;');
    }
...
console.log('%c© 2025 Michael Ostermann', 'font-size: 14px; color: #00FF41; font-weight: bold;');
