// ═════════════════════════════════════════════════════════════
// CYBERDYNE SYSTEMS - DEMO PROTECTION
...
(function() {
    ...
    function init() {
        ...
        console.clear();
        console.log('%c🔒 DEMO VERSION', 'background: #FF0000; color: white; font-size: 20px; padding: 10px; font-weight: bold;');
        console.log('%c⚠️ Diese Demo-Version ist geschützt!', 'font-size: 14px; color: #FF0000; font-weight: bold;');
        console.log('%cRechtsklick, Kopieren und Code-Zugriff sind deaktiviert.', 'font-size: 12px; color: #666;');
        console.log('%c© 2025 Michael Ostermann', 'font-size: 12px; color: #00FF41; font-weight: bold;');
    }
