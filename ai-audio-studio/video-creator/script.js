/* =====================================================
   AI Audio Studio - Video Creator Script
   ===================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('🎬 Video Creator Module Initialized');
  ...
  showNotification('🚀 Video Generator in Entwicklung! Coming Soon Q2 2026', 'info', 5000);
});
...
function initEventListeners() {
  ...
  // Video form (disabled for now)
  const videoForm = document.getElementById('videoForm');
  if (videoForm) {
    videoForm.addEventListener('submit', (e) => {
      e.preventDefault();
      showNotification('⏳ Video Generator noch nicht verfügbar', 'info', 3000);
    });
  }
...
async function handleNotifySubmit(e) {
  ...
  // Mock success (no backend yet)
  showNotification(`🔔 Danke! Wir benachrichtigen dich auf ${email}`, 'success', 4000);
  e.target.reset();
  ...
  //   method: 'POST',
  //   headers: { 'Content-Type': 'application/json' },
  //   body: JSON.stringify({ email, module: 'video-creator' })
  // });
}
...
function createBackgroundParticles() {
  const colors = ['#FF1493', '#9D00FF', '#FFD700', '#06FFF0']; // Pink, Purple, Gold, Cyan
